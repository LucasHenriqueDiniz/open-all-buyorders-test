...
(function () {
  "use strict";
  let maxLoop = 5; // Define o número máximo de páginas a serem processadas
  ...
  async function findNextPage() {
    if (currentLoop < maxLoop) {
      ...
      if (nextButton) {
        ...
        nextButton.click();
        currentLoop++;
        await delay(1500); // Aguarda 1.5 segundos antes de continuar
  ...
  input.type = "number";
  input.className = "form-control border border-start-0 searchbo";
